  ...
  const getDrinks = async () => {
    ...
    try {
      ...
      querySnapshot.forEach(async (doc) => {
        ...
        setDataDrinks((arr: any) => [...arr, { ...res, id: doc.id, imageUrl1: imageUrl1, imageUrl2: imageUrl2, imageUrl3: imageUrl3}]);
      });
    } catch (error) {
        console.log(error)                    
    }finally{
  ...
  const getFood = async () => {
    ...
    try {
      ...
      querySnapshot.forEach(async (doc) => {
        ...
        const imageUrl2 = await getDownloadURL(ref(storage, res.image2));
        const imageUrl3 = await getDownloadURL(ref(storage, res.image3));
        setDataFood((arr: any) => [...arr, { ...res, id: doc.id, imageUrl1: imageUrl1, imageUrl2: imageUrl2, imageUrl3: imageUrl3}]);
      });
    } catch (error) {
        console.log(error)                    
    }finally{
